...
const Student_batch = () => {
    ...
    const showUsers = () => {
        axios
            .get("http://localhost:8000/getSutedentBatch")
            .then((res) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (editingId) {
            axios
                .put(`http://localhost:8000/updateSutedentBatch/${editingId}`, newData)
                .then(() => {
            ...
            axios
                .post("http://localhost:8000/addSutedentBatch", newData)
                .then(() => {
    ...
    const deletedata = (_id) => {
        axios
            .delete(`http://localhost:8000/deleteSutedentBatch/${_id}`)
            .then(() => {
                ...
                <Row>
                    <Col md={4}>
                        <Breadcrumb>
                            ...
                            <Breadcrumb.Item active>Student Batch</Breadcrumb.Item>
                        </Breadcrumb>
                    </Col>
