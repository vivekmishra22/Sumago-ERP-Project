            ...
            <div className="sidebar d-none d-md-block">
                <Row>
                    <Col>
                        ...
                        <br />
                        <br />
                        <h2 className="text-white ps-3">Human Resource</h2>

                        <Nav defaultActiveKey="/User" className="flex-column link-unstyled text-white ">
                            {/* Dashboard Link */}
                            <Link
                                to="/Head/dashboard"
                            ...
                            <Link
                                to="/Head/AdmittedStudent"
                                className="text-decoration-none  link ps-3 py-2"
                            >
                                <MdSpaceDashboard size={25} className="me-2" /> Admitted Student List
                            </Link>
                            <Link
                                to="/Head/StudentLogin"
                                className="text-decoration-none  link ps-3 py-2"
                            >
                                <AiOutlineLogin   size={25} className="me-2" /> Student Login
                            </Link>
                            {/* Masters Dropdown */}
