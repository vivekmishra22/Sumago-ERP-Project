            ...
            <div className="sidebar d-none d-md-block vh-100 bg-dark">
                <Row className="h-100">
                    <Col className="d-flex flex-column h-100">
                        <h2 className="text-white ps-3 mt-5 mb-0 pt-4 text-center">Student</h2>
                        ...
                        <Nav defaultActiveKey="/User" className="flex-column link-unstyled flex-grow-1 p-2">
                            ...
                            {/* Feedback Link */}
                            <Link to="/Head/feedback" className="text-decoration-none link ps-3 py-2 d-flex align-items-center">
                            ...
                            <Link to="/Head/documents" className="text-decoration-none link ps-3 py-2">
                                <GrDocumentImage size={23} className="me-2" />Pending Documents
                            </Link>
