...
const Education = () => {
      ...
      axios
        ...
        .catch((err) => {
          if (err.response && err.response.status === 400) {
            setErrorMessage("Education is already exist.."); // Set error message
          } else {
            console.error(err);
          }
        })
  ...
  const handlePdf = () => {
    ...
    doc.autoTable({
      ...
      body: userData.map((a, index) => [index + 1, a.education_name, a.status]),
      startY: 30,
    });
  ...
  return (
    <Container className="d-flex justify-content-end">
      <Row className="d-flex justify-content-center mt-2 pt-5">
        {/* Add City Button */}
        {/* <h1 className="fw-bold text-center text-primary ">Education </h1> */}
        <Row>
          <Col md={4}>
            <Breadcrumb>
        ...
        <Modal show={show} onHide={handleClose}>
          <Modal.Header closeButton>
            <Modal.Title>{editingId ? "Update Education" : "Add Education"}</Modal.Title>
          </Modal.Header>
          <Modal.Body>
