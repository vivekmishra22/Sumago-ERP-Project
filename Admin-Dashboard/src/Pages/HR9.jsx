...
const HR = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const newData = {
     ...
     if (editingId) {
      axios
        .put(`http://localhost:8000/updatehr/${editingId}`, newData,
      ...
      axios
        .post("http://localhost:8000/addhr", newData,
  ...
  const deletedata = (_id) => {
    axios
      .delete(`http://localhost:8000/deletehr/${_id}`)
      .then(() => {
