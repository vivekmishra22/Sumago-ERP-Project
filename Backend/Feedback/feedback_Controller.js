...
const add = async (req, res) => {
    const {
        ...
        materials_helpful, practical_exercises, trainer_knowledge_rating, trainer_approachability, trainer_pacing, confidence_in_computer_skills, learning_expectations_met,
